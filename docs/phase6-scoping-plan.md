...
| **Membership Sales by Plan** | Membership value sold, grouped by plan — contracted value, not collected revenue (see note below) | `Membership` | plan_id, total_value (`SUM(price_at_signup)`), currency_at_signup | date_range |
